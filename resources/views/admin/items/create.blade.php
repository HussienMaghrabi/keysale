...
@section('page-title',trans('language.items'))
@section('form-groups')
    @includeIf('admin.components.form.add.select', ['label' => trans("admin.category"),'name'=>'category_id', 'items'=> \App\MainCategory::all() , 'icon' => 'fa fa-list',])
    ...
    @includeIf('admin.components.form.add.select', ['label' => trans("admin.category"),'name'=>'category_id', 'items'=> \App\Sub_category::all() , 'icon' => 'fa fa-list',])
    @includeIf('admin.components.form.add.select', ['label' => trans("admin.category"),'name'=>'category_id', 'items'=> \App\Sub_sub_category::all() , 'icon' => 'fa fa-list',])
