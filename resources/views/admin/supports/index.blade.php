    ...
    @foreach($items as $item)
        <tr>
            ...
            <td>
                ...
                @includeIf("admin.components.buttons.edit" , ["href" => "supports/$item->id/edit"])
                @includeIf("admin.components.buttons.delete",["message" => "($item->dash_name)" ,  "action" => url("admin/supports/$item->id")])
            </td>
        </tr>
    @endforeach
@endsection
