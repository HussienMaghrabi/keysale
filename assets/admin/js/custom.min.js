$(function () {
    ...
    var i = function () {
        ...
        $(".navbar-brand span.hides").hide() , $(".navbar-brand span.show").show(), $(".scroll-sidebar, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"),
        $(".sidebartoggler i").addClass("ti-menu")) : ($("body").removeClass("mini-sidebar"),
        $(".navbar-brand span.hides").show() ,   $(".navbar-brand span.show").hide() );
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function () {
        ...
        $("body").removeClass("mini-sidebar"), $(".navbar-brand span.show").show() ,$(".navbar-brand span.show").hide()) : ($("body").trigger("resize"),
        $(".scroll-sidebar, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible"),
        $("body").addClass("mini-sidebar"), $(".navbar-brand span.hides").hide() , $(".navbar-brand span.show").show());
    ...
    $(window).scroll(function () {
        if ($(this).scrollTop()) {
            $('.navbar-collapse').addClass('alt-nav');
        } else {
            $('.navbar-collapse').removeClass('alt-nav');
        }
    });
});
